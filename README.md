...
💻 Estudante de Ciência da Computação na **São Paulo Tech School**, com formação técnica em Informática para Internet.
🚀 Foco em **desenvolvimento web**, **automação**, **dados** e **IA generativa** — aprendendo na prática, construindo projetos reais.

Gosto de pegar um problema do mundo real (mesmo que pequeno) e transformar em código: já passei por pipelines de dados, assistentes de voz com IA e sistemas web para faculdade. Sempre em movimento entre estudar teoria e sujar a mão no terminal.
...
![n8n](https://img.shields.io/badge/n8n-F0406B?style=flat&logo=n8n&logoColor=white)
